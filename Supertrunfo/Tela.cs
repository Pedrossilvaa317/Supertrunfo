...
namespace Supertrunfo
{
    public static class Tela
    {
        ...
        public static void ExibirPlacar(Jogador jogador1, Jogador jogador2)
        {
            Console.Clear();
            Console.WriteLine("==================================================");
            Console.WriteLine("                  FIM DE JOGO!                    ");
            Console.WriteLine("==================================================");
            Console.WriteLine($" {jogador1.Nome}: {jogador1.Pontuacao} pontos");
            Console.WriteLine($" {jogador2.Nome}: {jogador2.Pontuacao} pontos");
            Console.WriteLine("==================================================");

            if (jogador1.Pontuacao > jogador2.Pontuacao)
            {
                Console.WriteLine($" PARABÉNS {jogador1.Nome}, VOCÊ É O CAMPEÃO!");
            }
            else if (jogador2.Pontuacao > jogador1.Pontuacao)
            {
                Console.WriteLine($" PARABÉNS {jogador2.Nome}, VOCÊ É O CAMPEÃO!");
            }
            else
            {
